...
export default function BudgetsScreen({ transactions }: Props) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 110, paddingHorizontal: 16, marginTop: 20 }} showsVerticalScrollIndicator={false}>
...
function BudgetCard({
  category, spentAmount, budgetAmount, percent, isOver, progressColor, onChangeBudget
}: {
  category: string;
  spentAmount: number;
  budgetAmount: number;
...
const styles = StyleSheet.create({
  ...
  budgetInput: { color: C.textPrimary, fontSize: 15, fontWeight: 'bold', paddingVertical: 8, minWidth: 60, textAlign: 'right' },
